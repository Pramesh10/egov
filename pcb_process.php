...
if (!$con) {
  ...
  $sql = "SELECT bill_id,b_month,b_year,current_reading,previous_reading,unit_consumed,rate,subtotal,previous_due,total,ispaid from current_bill where customer_id=$customer_id ";
