...
if (!$con) {
  ...
  $sql = "SELECT customer_id,sc_number,name,phone,branch_name,demand_name from customer c,branch b,demand_type d where c.name like '%$name' and c.branch_id=b.branch_id and c.deamand_id=d.demand_id ";
