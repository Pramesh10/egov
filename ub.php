...
if (!$con) {
  ...
  $sql = "SELECT bill_id,b_month,b_year,current_reading,previous_reading,unit_consumed,rate,subtotal,previous_due,total,ispaid from current_bill where ispaid=0 ";
  ...
  while($row=mysqli_fetch_assoc($result))
  {
    ...
    <td><div class='d1'><a href='payment.php? bill_id=$row[bill_id]'>Pay Now</a></div></td>
    </tr>
    </table>";
  }
?>
