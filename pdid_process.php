...
if (!$con) {
  ...
  $sql = "SELECT bill_id,bill_amount,discount,penalty,payment_amount,payment_m_name from bill_payment b,payment_method p where b.payment_method_id=p.payment_method_id and customer_id=$customer_id ";
